...
fig = my_traces(fig, dyn, grps, colors, df_results, "linear_momentum_rmse", 1, 1,
                r'$\text{RMSe (}N.s^{-1} \text{)}$', r'$\text{Linear Momentum}$')
fig = my_traces(fig, dyn, grps, colors, df_results, "angular_momentum_rmse", 1, 2,
                r'$\text{RMSe (}N.m.s^{-1} \text{)}$', r'$\text{Angular Momentum}$')
fig = my_traces(fig, dyn, grps, colors, df_results, "int_T", 2, 1, r"$\text{Residuals (N.s)}$", r'$\text{Translation torques}$')
fig = my_traces(fig, dyn, grps, colors, df_results, "int_R", 2, 2, r"$\text{Residuals (N.m.s)}$", r'$\text{Rotation torques}$')
