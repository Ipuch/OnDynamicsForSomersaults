...
def root_implicit_qdddot_dynamic(
    ...
    return qdot, qddot, qdddot


def custom_configure_root_implicit_qdddot(ocp: OptimalControlProgram, nlp: NonLinearProgram):
    """
    ...
    ConfigureProblem.configure_dynamics_function(ocp, nlp, root_implicit_qdddot_dynamic)
